# Contributing to rmcmc

This outlines how to propose a change to rmcmc. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("UCL/rmcmc", fork = TRUE)`.
...
Please note that the rmcmc project is released with a [Contributor Code
of Conduct](http://github-pages.ucl.ac.uk/rmcmc/CODE_OF_CONDUCT.md). By
